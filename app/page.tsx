            ...
            <main className="relative container mx-auto px-6 pt-64 pb-32 z-10">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                        <Link
                            href="/login"
                            className="group relative px-10 py-5 text-white rounded-3xl text-lg font-black overflow-hidden shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_50px_rgba(28,38,236,0.5)] flex-1 sm:max-w-[200px]"
                            style={{ backgroundColor: '#1C26EC' }}
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700" />
                            <span className="relative z-10 text-center block">Soy Paciente</span>
                        </Link>
                        <Link
                            href="/login"
                            className="px-10 py-5 text-[#020714] border border-[#15F0EB]/20 rounded-3xl text-lg font-black backdrop-blur-2xl hover:-translate-y-2 hover:shadow-[0_0_50px_rgba(21,240,235,0.4)] transition-all duration-300 shadow-2xl flex-1 sm:max-w-[200px]"
                        ...
                        <Link
                            href="/login"
                            className="px-10 py-5 text-white border border-accent/20 rounded-3xl text-lg font-black backdrop-blur-2xl hover:-translate-y-2 hover:shadow-[0_0_50px_rgba(6,214,160,0.4)] transition-all duration-300 shadow-2xl flex-1 sm:max-w-[200px]"
                            style={{ backgroundColor: 'rgba(6,214,160,0.8)' }}
                        >
                            Laboratorio
                        </Link>
                    </div>
                    ...
                    <div className="mb-40 space-y-4">
                        ...
                        <div className="pt-4">
                            <Link href="/login/admin" className="text-white/20 hover:text-white text-[10px] font-black uppercase tracking-[0.3em] px-6 py-2 rounded-full border border-white/5 hover:border-white/20 transition-all backdrop-blur-xl">
